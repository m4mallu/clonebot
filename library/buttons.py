...
home_button = [[InlineKeyboardButton("🌏 Source", "source_btn"),
...
start_button = [[InlineKeyboardButton("🏅 GitHub 🏅", url="github.com/m4mallu/clonebot-ui"),
                 InlineKeyboardButton("⚙️Settings ⚙", "start_btn")]]

types_button = [[InlineKeyboardButton(" ⏺ Docs", "docs_btn"),
...
stop_button = [[InlineKeyboardButton("🚫 STOP 🚫", "stop_clone")]]

finished_button = [[InlineKeyboardButton("🏠  HOME", "start_btn"),
                    InlineKeyboardButton("❌  CLOSE", "close_btn")]]

terminate_btn = [[InlineKeyboardButton("🚫 TERMINATE 🚫", "terminate_btn"),
                  InlineKeyboardButton("❌  CLOSE", "close_btn")]]
