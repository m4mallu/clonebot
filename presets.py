...
𝘈 𝘶𝘴𝘦𝘳 𝘴𝘦𝘴𝘴𝘪𝘰𝘯 𝘪𝘴 𝘴𝘵𝘢𝘳𝘵𝘦𝘥 𝘪𝘯 𝘺𝘰𝘶𝘳 𝘢𝘤𝘤𝘰𝘶𝘯𝘵.
𝘐𝘧 𝘺𝘰𝘶 𝘬𝘯𝘰𝘸 𝘵𝘩𝘪𝘴, 𝘬𝘦𝘦𝘱 𝘵𝘩𝘪𝘴 𝘣𝘰𝘵 𝘶𝘯𝘣𝘭𝘰𝘤𝘬𝘦𝘥
/start 𝘶𝘴𝘪𝘯𝘨 𝘪𝘵. 𝘐𝘧 𝘺𝘰𝘶 𝘧𝘦𝘦𝘭𝘴 𝘭𝘪𝘬𝘦 𝘧𝘶𝘤𝘬𝘦𝘥-𝘶𝘱,
/terminate 𝘵𝘩𝘦 𝘴𝘦𝘴𝘴𝘪𝘰𝘯 𝘢𝘯𝘥 𝘣𝘭𝘰𝘤𝘬 𝘵𝘩𝘪𝘴 𝘣𝘰𝘵
𝘵𝘰𝘢𝘷𝘰𝘪𝘥 𝘶𝘴𝘢𝘨𝘦 𝘰𝘧 𝘺𝘰𝘶𝘳 𝘴𝘦𝘴𝘴𝘪𝘰𝘯 𝘢𝘨𝘢𝘪𝘯.
    """
    SESSION_STOP_INFO = """
𝐔𝐬𝐞𝐫 𝐬𝐞𝐬𝐬𝐢𝐨𝐧 𝐞𝐧𝐝𝐞𝐝:
...
𝘒𝘦𝘦𝘱 𝘴𝘶𝘣𝘴𝘤𝘳𝘪𝘣𝘦 𝘮𝘺 𝘯𝘦𝘸𝘴 <a href='https://github.com/m4mallu/clonebot-ui'>𝘏𝘌𝘙𝘌</a>
    """
    NOT_CONFIGURED = "𝙎𝙤𝙪𝙧𝙘𝙚 & 𝙏𝙖𝙧𝙜𝙚𝙩 𝙘𝙝𝙖𝙩𝙨 𝙣𝙤𝙩 𝙘𝙤𝙣𝙛𝙞𝙜𝙪𝙧𝙚𝙙 ⚠"
    BOT_BLOCKED_MSG = "Bot is blocked by the  session user !"
    PROMPT_TERMINATION = "𝘼𝙧𝙚 𝙨𝙪𝙧𝙚 ?\n\n𝘽𝙤𝙩 𝙬𝙞𝙡𝙡 𝙗𝙚 𝙨𝙩𝙤𝙥𝙥𝙚𝙙, 𝙖𝙣𝙙 𝙞𝙩𝙨 𝙬𝙤𝙧𝙠𝙨 !"
